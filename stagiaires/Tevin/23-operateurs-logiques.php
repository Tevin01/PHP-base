...
if ($age >= 18 && $genre == "F") {
    ...
    echo "Désolé, accès réservé aux femmes majeures uniquement";
}
...
if ($page <= 10 || $page >= 20){
    echo "La page $page est soit inférieure à 10, soit supérieure à 20";
}

else {
    echo "La page $page est entre 10 et 20";
}
...
if ($note <= 10 XOR $note >= 10) {
    echo "La $note est soit inférieure à 10, soit supérieure à 10";
}
